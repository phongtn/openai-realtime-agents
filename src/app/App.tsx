...
function App() {
    ...
    // ---------------------------------------------------------------------
    // Codec selector – lets you toggle between wideband Opus (48 kHz)
    // and narrowband PCMU/PCMA (8 kHz) to hear what the agent sounds like on
    ...
    // via global codecPatch at a module load
